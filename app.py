...
def runc_async_job_30_min():
    asyncio.create_task(job_30_min())
# Schedule the job to run every 15 minutes

schedule.every(15).minutes.do(run_async_job_15_min)
schedule.every(30).minutes.do(runc_async_job_30_min)
